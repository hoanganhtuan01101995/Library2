...
public class FindPasswordFragmentTablet extends DialogFragment implements OnClickListener {
    ...
    public static FindPasswordFragmentTablet newInstance(Context context) {
        FindPasswordFragmentTablet fragment = new FindPasswordFragmentTablet();
        return fragment;
    }

    public FindPasswordFragmentTablet() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_forgot_pass_tablet, container, false);
...
//        mEmailCheckMessageView = (TextView) v.findViewById(R.id.email_check_message);
        ...
        mCreateButton.setText(R.string.msgTitleCreatePassword);
