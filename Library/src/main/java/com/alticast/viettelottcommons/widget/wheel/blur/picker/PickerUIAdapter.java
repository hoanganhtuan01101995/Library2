...
class PickerUIAdapter extends ArrayAdapter<String> {
    ...
    private static final int ROTATION_TWICE_ABOVE = -10;
    private static final int ROTATION_FIRST = -20;
    private static final int ROTATION_BELOW = 10;
    private static final int ROTATION_TWICE_BELOW = 20;
